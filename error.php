...
$results_lines = DB::query("SELECT * FROM `client_error_temp` where `client_id`=%d and error_id=%d order by timestamp desc limit 0,500 ", $name,$error_id);
  									...
  									<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
										<thead>
											<tr>
												...
												<th>Count</th>
												<th>Browser</th>
                                                <th>Browser Version</th>                                                <th>Time</th>
											</tr>
										</thead>
										<tbody>
											...
											?>
												...
												<td class="center"><?php echo $row['os']; ?></td>
