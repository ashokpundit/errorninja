...
(function () {
    ...
    if (window._errs && _errs.shift) {
        for (var p = "https:" == location.protocol, w = "<form method='post' action='http" + (p ? "s" : "") + "://errorninja.com/"+_ik+"/print.php'>", m = [], r = "before", s = document.getElementsByTagName("script")[0], g = Array.prototype.slice, t = navigator.userAgent, k, n = function (a, e) {
