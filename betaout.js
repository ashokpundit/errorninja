...
(function () {
    ...
    if (window._errs && _errs.shift) {
        for (var p = "https:" == location.protocol, w = "<form method='post' action='http" + (p ? "s" : "") + "://errorninja.com/print.php'>", m = [], r = "before", s = document.getElementsByTagName("script")[0], g = Array.prototype.slice, t = navigator.userAgent, k, n = function (a, e) {
                ...
                try {
                    ...
                    d = l;
                    h = q + "<input type='text' name='user' value='betaout'>" + "</form><script>onload=function(){setTimeout(function(){document.forms[0].submit()},10);}\x3c/script>";
